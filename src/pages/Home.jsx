...
function Home() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      {/* ================= AMAZON BODY ================= */}
      <div className="relative -mt-32 z-10 px-4 md:px-6 lg:px-10 space-y-8">
    ...
    {topProducts.length === 0
      ? // Skeleton placeholders
        Array.from({ length: 6 }).map((_, i) => (
          <div
            key={i}
            className="min-w-[180px] w-60 h-60 bg-gray-200 rounded-lg animate-pulse"
          />
        ))
      : // Loaded products
        topProducts.map((product) => (
          <div
            key={product._id}
            className="min-w-[180px] w-60 flex-shrink-0"
          >
